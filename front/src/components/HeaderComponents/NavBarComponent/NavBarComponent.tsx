...
const NavBarComponent: React.FC = () => {
  ...
  return (
    <nav className="flex flex-col gap-2 md:flex-row md:gap-4 mt-8 h-fit py-5 sm:py-0 sm:h-[64px] w-screen md:w-[95%] bg-[#808080b7] justify-center bg-opacity-80 items-center rounded-2xl font-bold text-white">

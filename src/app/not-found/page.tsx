  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-white px-4">
      ...
      <div className="text-center mt-20">
        ...
        <p className="text-2xl text-white radhiumz mb-8">
          Parece que alguien cometió un error.
        </p>
        <p className="text-lime text-4xl radhiumz">
          No te preocupes, tú puedes elegir a quién echar!
        </p>
      </div>

      {/* Team Section */}
      <div className="mt-16 w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
        {/* Team Member 1 */}
          ...
          <div className="relative">
            <Link href="/">
              ...
              <Image
                ...
                width={200}
                height={200}
                className="rounded-full mb-4 shadow-lg absolute top-0 left-0 opacity-0 transition-opacity duration-300 hover:opacity-100"
              />
            </Link>
          </div>
          <h3 className="text-2xl radhiumz mb-2">Samuel</h3>
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-2xl radhiumz mb-2">Ana</h3>
          <p className="text-center text-gray-300 bg-black/40 px-6 py-4 rounded-xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-2xl radhiumz mb-2">Pilar</h3>
          <p className="text-center text-gray-300 bg-black/40 px-6 py-4 rounded-xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-2xl radhiumz mb-2">Esteban</h3>
          <p className="text-center text-gray-300 bg-black/40 px-6 py-4 rounded-xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-2xl radhiumz mb-2">Rosario</h3>
          <p className="text-center text-gray-300 bg-black/40 px-6 py-4 rounded-xl">

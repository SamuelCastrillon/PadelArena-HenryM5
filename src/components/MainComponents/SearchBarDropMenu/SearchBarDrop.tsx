...
import { ISearchBarDropProps } from "@/interfaces/ComponentsInterfaces/SearchBarDrop";
import React, { useState } from "react";

const SearchBarDrop: React.FC<ISearchBarDropProps> = ({ onSearch, categorias, onClear }) => {
